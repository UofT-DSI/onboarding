...
This folder contains all the materials needed to get technically set up for the DSI Microcredentials. Please follow the materials in the order outlined below.
...
3. [Tech Requirements](./tech_requirements.md): Minimum hardware and software needed to participate in the microcredential.
