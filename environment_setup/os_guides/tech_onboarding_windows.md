...
## Introduction
Welcome to your Windows onboarding guide! This document walks you through installing the core tools needed for the DSI Microcredential. For the best results, we recommend using Windows 11.
